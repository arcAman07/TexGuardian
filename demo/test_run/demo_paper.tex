...
\begin{table}[H]
    ...
    \begin{tabular}{lcccccc}
        \toprule
        Method & Long-Ctx & Sparse & Struct-Aware & Sub-Quad & Multi-Gran & Load-Bal \\
        \midrule
        BERT-base & $\times$ & $\times$ & $\times$ & $\times$ & $\times$ & N/A \\
        Longformer & $\checkmark$ & $\times$ & $\times$ & $\checkmark$ & $\times$ & N/A \\
        Switch Trans. & $\times$ & $\checkmark$ & $\times$ & $\times$ & $\times$ & $\checkmark$ \\
        LayoutLMv2 & $\times$ & $\times$ & $\checkmark$ & $\times$ & $\checkmark$ & N/A \\
        \midrule
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=0.75, every node/.style={font=\small}]
        ...
        \node[font=\scriptsize\itshape, text=gray] at (4.2,-2.8) {top-$k$ routing};
    \end{tikzpicture}
...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{\begin{tabular}{lccccccccc}
        \toprule
        Model & DocQA F1 & DocQA EM & NLI Acc & NLI F1 & R-1 & R-L & Struct EM & FLOPs & Inf (ms) \\
        \midrule
