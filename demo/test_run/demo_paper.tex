...
\begin{table}[H]
    ...
    \begin{tabular}{lcccccccccr}
        \toprule
        Method & Long-Context & Sparse Routing & Structure-Aware & Sub-Quadratic & Multi-Granularity & Load-Balanced & Cross-Document & Parameters & Training Cost & Year \\
        \midrule
        BERT-base & $\times$ & $\times$ & $\times$ & $\times$ & $\times$ & N/A & $\times$ & 110M & 16 TPU-days & 2019 \\
        Longformer & $\checkmark$ & $\times$ & $\times$ & $\checkmark$ & $\times$ & N/A & $\times$ & 149M & 24 TPU-days & 2020 \\
        Switch Transformer & $\times$ & $\checkmark$ & $\times$ & $\times$ & $\times$ & $\checkmark$ & $\times$ & 1.6B & 128 TPU-days & 2022 \\
        LayoutLMv2 & $\times$ & $\times$ & $\checkmark$ & $\times$ & $\checkmark$ & N/A & $\times$ & 426M & 64 TPU-days & 2021 \\
        \midrule
        \textbf{Ours} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & 380M & 48 A100-days & 2026 \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[H]
    \caption{Main results on document understanding benchmarks. Best in \textbf{bold}, second best \underline{underlined}.}
    \label{tab:main_results}
    \centering
    \begin{tabular}{lccccccccc}
        \toprule
        Model & DocQA F1 (\%) & DocQA EM (\%) & NLI Accuracy (\%) & NLI F1 (\%) & ROUGE-1 & ROUGE-L & Structure EM (\%) & FLOPs (TFLOPs) & Inference (ms) \\
        \midrule
        BERT-base & 62.3 & 54.1 & 71.8 & 70.2 & 32.1 & 28.4 & 41.2 & 0.8 & 12.4 \\
        Longformer & 68.7 & 61.3 & 76.4 & 74.9 & 36.8 & 33.1 & 48.7 & 2.1 & 31.7 \\
        Switch-base & 71.2 & 64.5 & 79.3 & 78.1 & 39.4 & 36.2 & 52.8 & 1.4 & 18.9 \\
        Ours (top-1) & \underline{78.4} & \underline{72.1} & \underline{84.7} & \underline{83.2} & \underline{43.1} & \underline{40.3} & \underline{61.4} & \underline{0.9} & \underline{14.2} \\
        Ours (top-2) & \textbf{82.5} & \textbf{76.8} & \textbf{87.1} & \textbf{86.3} & \textbf{45.8} & \textbf{43.2} & \textbf{64.7} & 1.2 & 16.8 \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[H]
    \caption{Ablation study on DocQA development set.}
    \label{tab:ablation}
    \centering
    \begin{tabular}{|l|c|c|}
        \hline
