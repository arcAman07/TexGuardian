...
\begin{tikzpicture}[
    scale=0.72,
    phase/.style={rectangle, rounded corners=4pt, line width=1pt, minimum width=1.5cm, minimum height=0.85cm, font=\scriptsize\bfseries, align=center},
    arrow/.style={->, >=stealth, line width=1.2pt, gray!70}
]
% Phase 1
\node[phase, draw=blue!60, fill=blue!15] (p1) at (0,0) {Phase 1\\Docs +\\Examples};
% Phase 2
\node[phase, draw=green!60, fill=green!15] (p2) at (2.6,0) {Phase 2\\Generate};
\node[phase, draw=orange!60, fill=orange!15] (p3) at (5.2,0) {Interpreter\\Execute};
\node[phase, draw=red!60, fill=red!15] (p4) at (7.8,0) {Update\\Context};
% Phase 3
\node[phase, draw=purple!60, fill=purple!15] (p5) at (10.4,0) {Phase 3\\Evaluate};
